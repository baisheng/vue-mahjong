...
-file("/usr/local/lib/erlang19/lib/erlang/lib/parsetools-2.1.4/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
-file("src/protobuffs_parser.erl", 201).
...
-dialyzer({nowarn_function, yeccgoto_g_message/7}).
...
-dialyzer({nowarn_function, yeccgoto_g_protobuffs/7}).
...
-dialyzer({nowarn_function, yeccgoto_g_var/7}).
